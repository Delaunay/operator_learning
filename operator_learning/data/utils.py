...
def getDataLoaders(dataFile,
    ...
    trainLoader = DataLoader(trainSet, persistent_workers=True, batch_size=train_batchSize, sampler=train_sampler, shuffle=(train_sampler is None), num_workers=num_workers, collate_fn=collate_fn, pin_memory=True)
